              ...
              <AnimatePresence initial={false} mode="wait">
                ...
                >
                  ...
                  {subhead && (
                    <p
                      className={cn(
                        "mt-5 ltr:mt-7 text-base sm:text-lg md:text-xl text-white/85 max-w-xl leading-[1.55] min-h-[52px] sm:min-h-[60px] md:min-h-[68px] hero-text-shadow hero-subhead-wrap",
