/**
 * ===========================================================================
 * Premium email template system — Youssef Elite
 * ===========================================================================
 *
...
type Strings = {
  ...
  signoffName: string;          // "Coach Youssef"
  questionsCta: string;         // "Have a question? Message me on WhatsApp."
  footerNote: string;           // "Sent automatically by Youssef Elite."
  ...
  // Welcome
  welcomeSubject: string;       // "Welcome to Youssef Elite"
...
const en: Strings = {
  ...
  signoffName: "Coach Youssef",
  questionsCta: "Have a question? Message Coach Youssef directly on WhatsApp.",
  footerNote: "Sent automatically by Youssef Elite.",
  footerUnsubNote: "You're receiving this because you have an active account with Youssef Elite.",
  ctaDashboard: "Open my dashboard",
  ctaWhatsapp: "Message Coach on WhatsApp",

  welcomeSubject: "Welcome to Youssef Elite",
  ...
  welcomeRule2: "Cancel or reschedule at least 3 hours in advance.",
  ...
  bookingRule2: "Cancel or reschedule at least 3 hours in advance.",
  ...
  resetBody: "We received a request to reset the password on your Youssef Elite account. Tap the button below to set a new password.",
...
const ar: Strings = {
  ...
  footerNote: "أُرسلت تلقائياً من Youssef Elite.",
  footerUnsubNote: "تتلقى هذه الرسالة لأن لديك حساباً نشطاً مع Youssef Elite.",
  ctaDashboard: "افتح لوحة التحكم",
  ctaWhatsapp: "تواصل مع الكوتش عبر واتساب",

  welcomeSubject: "أهلاً بك في Youssef Elite",
  ...
  welcomeRule2: "يجب الإلغاء أو إعادة الجدولة قبل 3 ساعات على الأقل.",
  ...
  bookingRule2: "الإلغاء أو إعادة الجدولة قبل 3 ساعات على الأقل.",
  ...
  resetBody: "تلقينا طلباً لإعادة تعيين كلمة المرور لحسابك في Youssef Elite. اضغط الزر أدناه لتعيين كلمة مرور جديدة.",
...
const fr: Strings = {
  ...
  footerNote: "Envoyé automatiquement par Youssef Elite.",
  footerUnsubNote: "Vous recevez cet email car vous avez un compte actif chez Youssef Elite.",
  ctaDashboard: "Ouvrir mon tableau de bord",
  ctaWhatsapp: "Écrire au coach sur WhatsApp",
  welcomeSubject: "Bienvenue chez Youssef Elite",
  ...
  welcomeRule2: "Annulez ou reprogrammez au moins 3 heures à l'avance.",
  ...
  bookingRule2: "Annulez ou reprogrammez au moins 3 heures à l'avance.",
  ...
  resetBody: "Nous avons reçu une demande de réinitialisation du mot de passe de votre compte Youssef Elite. Cliquez sur le bouton ci-dessous pour en définir un nouveau.",
...
const de: Strings = {
  ...
  footerNote: "Automatisch versendet von Youssef Elite.",
  footerUnsubNote: "Du erhältst diese E-Mail, weil du ein aktives Konto bei Youssef Elite hast.",
  ctaDashboard: "Mein Dashboard öffnen",
  ctaWhatsapp: "Coach auf WhatsApp schreiben",
  welcomeSubject: "Willkommen bei Youssef Elite",
  ...
  welcomeRule2: "Mindestens 3 Stunden vorher absagen oder umplanen.",
  ...
  bookingRule2: "Mindestens 3 Stunden vorher absagen oder umplanen.",
...
const es: Strings = {
  ...
  footerNote: "Enviado automáticamente por Youssef Elite.",
  footerUnsubNote: "Recibes este correo porque tienes una cuenta activa con Youssef Elite.",
  ctaDashboard: "Abrir mi panel",
  ctaWhatsapp: "Escribir al coach por WhatsApp",
  welcomeSubject: "Bienvenido a Youssef Elite",
  ...
  welcomeRule2: "Cancela o reprograma con al menos 3 horas de antelación.",
  ...
  bookingRule2: "Cancela o reprograma con al menos 3 horas de antelación.",
  ...
  resetBody: "Recibimos una solicitud para restablecer la contraseña de tu cuenta Youssef Elite. Pulsa el botón para establecer una nueva.",
...
const ru: Strings = {
  ...
  footerNote: "Отправлено автоматически Youssef Elite.",
  footerUnsubNote: "Вы получили это письмо, потому что у вас активный аккаунт в Youssef Elite.",
  ctaDashboard: "Открыть мой кабинет",
  ctaWhatsapp: "Написать тренеру в WhatsApp",
  welcomeSubject: "Добро пожаловать в Youssef Elite",
  ...
  welcomeRule2: "Отмена или перенос — минимум за 3 часов.",
  ...
  bookingRule2: "Отмена или перенос — минимум за 3 часов.",
  ...
  resetBody: "Мы получили запрос на сброс пароля вашей учётной записи Youssef Elite. Нажмите кнопку ниже, чтобы задать новый пароль.",
...
const tr: Strings = {
  ...
  signoffName: "Koç Youssef Elite",
  questionsCta: "Sorun mu var? Koç Youssef'e doğrudan WhatsApp'tan yaz.",
  footerNote: "Youssef Elite tarafından otomatik gönderildi.",
  footerUnsubNote: "Bu e-postayı Youssef Elite'de aktif hesabınız olduğu için alıyorsunuz.",
  ctaDashboard: "Panelimi aç",
  ctaWhatsapp: "Koça WhatsApp'tan yaz",
  welcomeSubject: "Youssef Elite'e hoş geldin",
  ...
  welcomeRule2: "En az 3 saat önceden iptal veya yeniden planla.",
  ...
  bookingRule2: "En az 3 saat önceden iptal veya yeniden planla.",
  ...
  resetBody: "Youssef Elite hesabın için şifre sıfırlama isteği aldık. Yeni bir şifre belirlemek için aşağıdaki butona dokun.",
...
const zh: Strings = {
  ...
  greeting: "您好 {name}，",
  signoff: "期待与您见面，",
  signoffName: "教练 Youssef Elite",
  questionsCta: "有任何问题？请直接在 WhatsApp 联系 Youssef 教练。",
  footerNote: "由 Youssef Elite 自动发送。",
  footerUnsubNote: "您收到此邮件是因为您在 Youssef Elite 拥有有效账户。",
  ctaDashboard: "打开我的面板",
  ctaWhatsapp: "WhatsApp 联系教练",
  welcomeSubject: "欢迎加入 Youssef Elite",
  ...
  resetSubject: "重置您的密码",
  resetHero: "重置您的密码",
  resetBody: "我们收到了重置您 Youssef Elite 账户密码的请求。请点击下方按钮设置新密码。",
  resetCta: "重置密码",
...
const hi: Strings = {
  ...
  signoffName: "कोच Youssef Elite",
  questionsCta: "कोई सवाल है? कोच Youssef को सीधे WhatsApp पर मैसेज करें।",
  footerNote: "Youssef Elite द्वारा स्वचालित रूप से भेजा गया।",
  footerUnsubNote: "आपको यह ईमेल इसलिए मिल रही है क्योंकि आपका Youssef Elite में सक्रिय खाता है।",
  ctaDashboard: "मेरा डैशबोर्ड खोलें",
  ctaWhatsapp: "कोच को WhatsApp पर मैसेज करें",
  welcomeSubject: "Youssef Elite में आपका स्वागत है",
  ...
  welcomeRule2: "कम से कम 3 घंटे पहले कैंसल या रीशेड्यूल करें।",
  ...
  bookingRule2: "कम से कम 3 घंटे पहले कैंसल या रीशेड्यूल करें।",
  ...
  resetBody: "हमें आपके Youssef Elite खाते का पासवर्ड रीसेट करने का अनुरोध मिला है। नया पासवर्ड सेट करने के लिए नीचे बटन दबाएं।",
...
const ur: Strings = {
  ...
  footerNote: "Youssef Elite کی طرف سے خودکار طور پر بھیجا گیا۔",
  footerUnsubNote: "آپ کو یہ ای میل اس لیے موصول ہو رہی ہے کیونکہ Youssef Elite میں آپ کا فعال اکاؤنٹ ہے۔",
  ctaDashboard: "میرا ڈیش بورڈ کھولیں",
  ctaWhatsapp: "کوچ کو واٹس ایپ پر پیغام دیں",
  welcomeSubject: "Youssef Elite میں خوش آمدید",
  ...
  welcomeRule2: "کم از کم 3 گھنٹے پہلے منسوخ یا دوبارہ شیڈول کریں۔",
  ...
  bookingRule2: "کم از کم 3 گھنٹے پہلے منسوخ یا دوبارہ شیڈول کریں۔",
  ...
  resetBody: "ہمیں آپ کے Youssef Elite اکاؤنٹ کے پاس ورڈ کو ری سیٹ کرنے کی درخواست موصول ہوئی ہے۔ نیا پاس ورڈ سیٹ کرنے کے لیے نیچے بٹن دبائیں۔",
...
const pt: Strings = {
  ...
  footerNote: "Enviado automaticamente por Youssef Elite.",
  footerUnsubNote: "Você recebeu este email porque tem uma conta ativa na Youssef Elite.",
  ctaDashboard: "Abrir meu painel",
  ctaWhatsapp: "Falar com o coach no WhatsApp",
  welcomeSubject: "Bem-vindo à Youssef Elite",
  ...
  welcomeRule2: "Cancele ou reagende com pelo menos 3 horas de antecedência.",
  ...
  bookingRule2: "Cancele ou reagende com pelo menos 3 horas de antecedência.",
  ...
  resetBody: "Recebemos um pedido para redefinir a senha da sua conta Youssef Elite. Toque no botão abaixo para definir uma nova.",
...
const it: Strings = {
  ...
  footerNote: "Inviato automaticamente da Youssef Elite.",
  footerUnsubNote: "Ricevi questa email perché hai un account attivo su Youssef Elite.",
  ctaDashboard: "Apri la mia dashboard",
  ctaWhatsapp: "Scrivi al coach su WhatsApp",
  welcomeSubject: "Benvenuto in Youssef Elite",
  ...
  welcomeRule2: "Cancella o riprogramma almeno 3 ore prima.",
  ...
  bookingRule2: "Cancella o riprogramma almeno 3 ore prima.",
  ...
  resetBody: "Abbiamo ricevuto una richiesta di reimpostazione della password del tuo account Youssef Elite. Tocca il pulsante per impostarne una nuova.",
