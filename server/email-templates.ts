...
const fr: Strings = {
  ...
  expiringBodyLow: "Il vous reste {n} séance{plural} sur votre forfait actuel. Renouvelez maintenant pour garder votre élan.",
  expiringBodyDays: "Votre forfait expire dans {n} jour{plural}. Renouvelez maintenant pour garder vos créneaux.",
...
const de: Strings = {
  ...
  expiringBodyLow: "Du hast noch {n} Session{plural} in deinem aktuellen Paket. Verlängere jetzt, damit dein Schwung nicht abbricht.",
  expiringBodyDays: "Dein Paket läuft in {n} Tag{plural} ab. Verlängere jetzt, um deine Slots zu sichern.",
...
const es: Strings = {
  ...
  expiringBodyLow: "Te quedan {n} sesion{plural} en tu paquete actual. Renueva ahora para mantener tu impulso.",
  expiringBodyDays: "Tu paquete vence en {n} día{plural}. Renueva ahora para conservar tus huecos.",
...
const pt: Strings = {
  ...
  expiringBodyLow: "Você tem {n} sessão{plural} restante{plural} no pacote atual. Renove agora para manter o ritmo.",
  expiringBodyDays: "Seu pacote vence em {n} dia{plural}. Renove agora para manter seus horários.",
...
const it: Strings = {
  ...
  expiringBodyLow: "Ti restano {n} sessione{plural} sul pacchetto attuale. Rinnova ora per non perdere lo slancio.",
  expiringBodyDays: "Il tuo pacchetto scade tra {n} giorno{plural}. Rinnova ora per mantenere i tuoi slot.",
