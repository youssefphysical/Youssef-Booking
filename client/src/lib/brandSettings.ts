...
export const LOGO_BRAND_SLOT_DEFAULTS: Record<LogoSlot, LogoBrandControls> = {
  ...
  mobile:    { wDesktop:   0, hDesktop:  54, wMobile:   0, hMobile:  54, zoom: 100, hOffset: 0, vOffset: 0, padding: 2,  glow: 15, minHeroH:   0 },
  ...
  footer:    { wDesktop:   0, hDesktop:  36, wMobile:   0, hMobile:  32, zoom: 100, hOffset: 0, vOffset: 0, padding: 3,  glow: 25, minHeroH:   0 },
