...
> = {
  ...
  body_metric: { Icon: Scale, tone: "text-white/60", ring: "ring-white/10" },
  weekly_checkin: { Icon: ClipboardCheck, tone: "text-amber-300", ring: "ring-amber-400/30" },
  inbody: { Icon: ActivityIcon, tone: "text-cyan-300", ring: "ring-cyan-400/30" },
  progress_photo: { Icon: Camera, tone: "text-primary", ring: "ring-primary/30" },
