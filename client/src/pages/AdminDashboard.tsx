...
// AdminTabs has been extracted to client/src/components/admin/AdminTabs.tsx
// and is now mounted globally for every /admin/* route via App.tsx.
// Re-exported here for any external import that still references the
// old location.
export { AdminTabs } from "@/components/admin/AdminTabs";
